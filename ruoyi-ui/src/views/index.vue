    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">总注册学生数</div>
            <div class="card-panel-num">4,521</div>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">平台累计交易额</div>
            <div class="card-panel-num">￥89,452</div>
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">在售闲置商品</div>
            <div class="card-panel-num">875</div>
          </div>
        </div>
      </el-col>
    </el-row>
      ...
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <div v-for="o in 5" :key="o" class="text item">
            <el-tag size="mini" :type="o%2==0 ? 'success' : 'warning'" style="margin-right:10px">
              {{ o%2==0 ? '二手交易' : '校园跑腿' }}
            </el-tag>
            用户 188****{{ Math.floor(Math.random()*9000)+1000 }} 刚刚发布了新的请求
            <span style="float: right; color: #999; font-size: 13px;">{{ o }} 分钟前</span>
          </div>
        </el-card>
      </el-col>
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <div style="margin-bottom: 15px;">服务器 CPU 使用率</div>
          <el-progress :text-inside="true" :stroke-width="20" :percentage="24" status="success"></el-progress>
          <div style="margin-top: 15px; margin-bottom: 15px;">数据库 内存 使用率</div>
          <el-progress :text-inside="true" :stroke-width="20" :percentage="58"></el-progress>
        </el-card>
      </el-col>
    </el-row>
  </div>
...
.panel-group {
  ...
  .card-panel {
    height: 108px; cursor: pointer; font-size: 12px;
    position: relative; overflow: hidden;
    color: #666; background: #fff;
    box-shadow: 4px 4px 40px rgba(0, 0, 0, .05);
    border-color: rgba(0, 0, 0, .05); border-radius: 10px;
    &:hover {
    ...
    .card-panel-icon-wrapper {
      ...
      padding: 16px; transition: all 0.38s ease-out; border-radius: 6px;
    }
    ...
    .card-panel-description {
      float: right; font-weight: bold; margin: 26px 26px 26px 0;
      .card-panel-text { line-height: 18px; color: #8ca0a8; font-size: 16px; margin-bottom: 12px; }
      .card-panel-num { font-size: 24px; color: #333; }
    }
  }
}
.text { font-size: 14px; }
.item { margin-bottom: 18px; padding-bottom: 10px; border-bottom: 1px solid #f0f0f0; }
.box-card { border-radius: 10px; border: none; box-shadow: 4px 4px 40px rgba(0, 0, 0, .05); }
</style>
